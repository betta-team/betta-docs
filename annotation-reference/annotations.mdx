...
This annotation will add a ambient sound emmiter, the value can be used to select different ambient sounds.

## Interactions

### b_interaction_modal

This annotation will make the mesh clickable, the cursor will become a pointer when hovering over the mesh, clicking will display a modal
...
This annotation will mark the mesh as a seat, this annotation must be accompanied by a `b_seat_start` annotation and a `b_seat_end`

### b_seat_start

This annotation will mark a transform as the starting position to sitdown on a seat

### b_seat_end

This annotation will mark a transform as the finishing position
...
This annotation will change the alpha position of the camera, accepted values are:
...
This annotation will adjust the beta value of the follow camera, 1 is the default, 1.45 is closer being parallel with the avatar

### b_camera_radius

This annotation will change the radius, or distance of the camera from the avatar, the default is 10, 5 would be closer.
...
| Property                       | Value              |
| ------------------------------ | ------------------ |
| b_content_receiver_orientation | LANDSCAPE/PORTRAIT |
...
| Property                | Value       |
| ----------------------- | ----------- |
| b_content_receiver_type | VIDEO/IMAGE |
