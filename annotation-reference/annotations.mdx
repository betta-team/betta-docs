...
This annotation will zoom the camera from a standard position, to more of a follow position as long as the avatar intersects with the bounding box of the mesh
